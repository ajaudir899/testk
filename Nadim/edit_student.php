        ...
        <?php endif; ?>
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>Student ID:</td>
                        <td><input type="text" name="student_id" value="<?php echo htmlspecialchars($students['student_id']); ?>" placeholder="Student ID" required></td>
                    </tr>

                    <tr>
                        <td>IC:</td>
                        <td><input type="text" name="student_ic" value="<?php echo htmlspecialchars($students['student_ic']); ?>" placeholder="IC" required></td>
                    </tr>

                    <tr>
                        <td>Name:</td>
                        <td><input type="text" name="student_name" value="<?php echo htmlspecialchars($students['student_name']); ?>" placeholder="Name" required></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="student_gender" required>
                                ...
                                <option value="male" <?php echo ($students['student_gender'] == 'male') ? 'selected' : ''; ?>>Male</option>
                                <option value="female" <?php echo ($students['student_gender'] == 'female') ? 'selected' : ''; ?>>Female</option>
                            </select>
                        </td>                    
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="student_race" name="student_race" onchange="toggleOtherRaceField()">
                                <option value="Malay" <?php echo ($students['student_race'] === 'Malay') ? 'selected' : ''; ?>>Malay</option>
                                <option value="Chinese" <?php echo ($students['student_race'] === 'Chinese') ? 'selected' : ''; ?>>Chinese</option>
                                <option value="Indian" <?php echo ($students['student_race'] === 'Indian') ? 'selected' : ''; ?>>Indian</option>
                                <option value="Others" <?php echo ($students['student_race'] === 'Others') ? 'selected' : ''; ?>>Others</option>
                            </select>
                    ...
                    <tr>
                        <td>Phone No:</td>
                        <td><input type="text" name="student_phone_no" value="<?php echo htmlspecialchars($students['student_phone_no']); ?>" placeholder="Phone No" required></td>
                    </tr>

                    <tr>
                        <td>Home No:</td>
                        <td><input type="text" name="student_home_no" value="<?php echo htmlspecialchars($students['student_home_no']); ?>" placeholder="Home No" required></td>
                    </tr>

                    <tr>
                        <td>Email:</td>
                        <td><input type="email" name="student_email" value="<?php echo htmlspecialchars($students['student_email']); ?>" placeholder="Email" required></td>
                    </tr>

                    <tr>
                        <td>Address:</td>
                        <td><input type="text"  name="student_addr"  value="<?php echo htmlspecialchars($students['student_addr']); ?>" placeholder="Address" required></td>
                    </tr>

                    <tr>
                        <td>State:</td>
                        <td><input type="text" name="student_state" value="<?php echo htmlspecialchars($students['student_state']); ?>" placeholder="State" required></td>
                    </tr>

                    <tr>
                        <td>Batch ID:</td>
                        <td><input type="text" name="student_batch_id" value="<?php echo htmlspecialchars($students['student_batch_id']); ?>" placeholder="Batch ID" required></td>
                    </tr>
                    ...
                    <tr>
                        <td>Status:</td>
                        <td><input type="text" name="student_status" value="<?php echo htmlspecialchars($students['student_status']); ?>" placeholder="Status" required></td>
                    </tr>

                    <tr>
                        <td>Category:</td>
                        <td><input type="text" name="student_category" value="<?php echo htmlspecialchars($students['student_category']); ?>" placeholder="Category" required></td>
                    </tr>

                    <tr>
                        <td>Sponsor:</td>
                        <td><input type="text" name="student_sponsor" value="<?php echo htmlspecialchars($students['student_sponsor']); ?>" placeholder="Sponsor" required></td>
                    </tr>

                    <tr>
                        <td>Father's Name:</td>
                        <td><input type="text" name="student_father_name" value="<?php echo htmlspecialchars($students['student_father_name']); ?>" placeholder="Father's Name" required></td>
                    </tr>

                    <tr>
                        <td>Father's Phone:</td>
                        <td><input type="text" name="student_father_phone" value="<?php echo htmlspecialchars($students['student_father_phone']); ?>" placeholder="Father's Phone" required></td>
                    </tr>

                    <tr>
                        <td>Father's Address:</td>
                        <td><input type="text"  name="student_father_addr" value="<?php echo htmlspecialchars($students['student_father_addr']); ?>" placeholder="Father's Address" required ></td>
                    </tr>

                    <tr>
                        <td>Mother's Name:</td>
                        <td><input type="text" name="student_mother_name" value="<?php echo htmlspecialchars($students['student_mother_name']); ?>" placeholder="Mother's Name" required></td>
                    </tr>

                    <tr>
                        <td>Mother's Phone:</td>
                        <td><input type="text" name="student_mother_phone" value="<?php echo htmlspecialchars($students['student_mother_phone']); ?>" placeholder="Mother's Phone" required></td>
                    </tr>

                    <tr>
                        <td>Mother's Address:</td>
                        <td><input type="text" name="student_mother_addr" value="<?php echo htmlspecialchars($students['student_mother_addr']); ?>" placeholder="Mother's Address" required></td>
                    </tr>

                    <tr>
                        <td>Note:</td>
                        <td><textarea name="student_note" placeholder="Note"><?php echo htmlspecialchars($students['student_note']); ?></textarea></td>
                    </tr>
