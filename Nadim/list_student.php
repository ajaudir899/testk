...
if (isset($_GET['id']) && !isset($_GET['action'])) {
    ...
    $stmt = $conn->prepare("SELECT id, student_id, student_ic, student_name, student_gender, student_race, student_phone_no, student_home_no, student_email, student_addr, student_state, student_batch_id, student_reg_date, student_status, student_category, student_sponsor, student_father_name, student_father_phone, student_father_addr, student_mother_name, student_mother_phone, student_mother_addr, student_note FROM tblstudent WHERE id = ?");
    $stmt->bind_param("i", $id);
    $stmt->execute();
    ...
    <div class="student-detail">
        ...
        <div>
            ...
            <table class="table additional-details">
                ...
                <tr>
                    <th>Sponsor</th>
                    <td><?php echo htmlspecialchars($student['student_sponsor']); ?></td>
                </tr>
            </table>
        </div>
